...
export default function PlannerClient({ initialHabits }: PlannerClientProps) {
  ...
  // Handler para toggle de lembrete
  ...
  // Handler para salvar novo lembrete
...
function WeekViewContent({
  ...
  return (
    <section>
      <h2 className="text-xl font-heading uppercase tracking-widest text-[#d4af37] mb-6">
        SEMANA
      </h2>
